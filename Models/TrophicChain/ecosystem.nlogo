...
globals [
  ...
  ; trophic matrix defined as
  ;   M_ij = # fishes (per individual) of species j eaten by i when both encounter
  trophic-matrix
  ...
  ; ressources-matrix : species -> ressource : how much eats when ecounters
  ressources-matrix
  
  ; how much energy do ressources provide
  ressources-energy-matrix
...
; one breed only for all species, in order to have flexibility in number and trophic matrix
breed[fishes fish]
